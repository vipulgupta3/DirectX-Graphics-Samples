...
## Known limitations
  ...
  - AMD: current/v1.3 revision of the DXR samples and Fallback Layer are not supported on AMD cards and will fail to run. Temporarily, you can use previous v1.2 source snapshot with v1.1 SDK overlay binary snapshot which work on AMD: 
